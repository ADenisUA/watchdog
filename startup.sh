...
sleep 10
sudo -u pi autossh -M 0 -f -o "ServerAliveInterval 30" -o "ServerAliveCountMax 3" -N -R 3333:localhost:80 -p 2244 rssh@j1.qr-code.ws &
sudo -u pi autossh -M 0 -f -o "ServerAliveInterval 30" -o "ServerAliveCountMax 3" -N -R 3334:localhost:443 -p 2244 rssh@j1.qr-code.ws &
